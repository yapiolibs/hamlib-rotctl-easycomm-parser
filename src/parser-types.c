...
void easycommSingleLine(EasycommSingleLine *d) { memset(d, 0, sizeof(EasycommSingleLine)); }


void easycommPayload(EasycommPayload *d) { memset(d, 0, sizeof(EasycommPayload)); }


void easycommData(EasycommData *d) { memset(d, 0, sizeof(EasycommData)); }
...
bool easycommSingleLineEquals(const EasycommSingleLine *a, const EasycommSingleLine *b)
{
    ...
    return (a == NULL && b == NULL) ||
           ((a != NULL && b != NULL) && (a->azimuth <= b->azimuth + margin && a->azimuth >= b->azimuth - margin) &&
